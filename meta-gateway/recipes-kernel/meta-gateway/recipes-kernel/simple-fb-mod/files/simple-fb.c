...
#include <linux/clk-provider.h>//of_clk_...()
#include <linux/of_platform.h>
#include <linux/parser.h>
#include <linux/regulator/consumer.h>

//Resolving of_chosen unknown parameter
//extern struct device node *of_find_node_opts_by_path;
...
static int simplefb_remove(struct platform_device *pdev)
{
	...
	unregister_framebuffer(info);//returns int 0 success, <0 errno fail
	framebuffer_release(info);
